...
use Pinball\PinballBundle\Entity\Manufacturer;
use Pinball\PinballBundle\Form\ManufacturerType;
...
class ManufacturerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PinballPinballBundle:Manufacturer')->findAll();
     ...
     * @Method("POST")
     * @Template("PinballPinballBundle:Manufacturer:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PinballPinballBundle:Manufacturer')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PinballPinballBundle:Manufacturer:edit.html.twig")
     */
